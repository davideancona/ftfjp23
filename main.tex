...
In this paper we propose a Runtime Verification techniques to avoid or at least mitigate this issue.

Our proposed solution uses \rml, a rewriting-based Domain Specific Language for Runtime Verification
...
%% Keywords. The author(s) should pick words that accurately describe
%% the work being presented. Separate the keywords with commas.
\keywords{Java, hash code, mutable classes, runtime verification}
